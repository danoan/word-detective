#ifndef WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_FRENCH_HPP
#define WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_FRENCH_HPP
...
class FrenchSegmenter : public SegmenterInterface {
 public:
 ...
 public:
  explicit FrenchSegmenter(std::istream* in_stream,
                            FilterFunction filter = always_true_filter)
...
template <>
class SegmenterSelector<Languages::French> {
 public:
  using Segmenter = FrenchSegmenter;
};
