#ifndef WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_PORTUGUESE_HPP
#define WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_PORTUGUESE_HPP
...
class PortugueseSegmenter : public SegmenterInterface {
 public:
 ...
 public:
  explicit PortugueseSegmenter(std::istream* in_stream,
                            FilterFunction filter = always_true_filter)
...
template <>
class SegmenterSelector<Languages::Portuguese> {
 public:
  using Segmenter = PortugueseSegmenter;
};
