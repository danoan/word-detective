...
def render_page(templateFolder, jsonPuzzlePath, outputFolder, cookieUniqueId="sunday"):
    dirs_to_copy = ['assets',
                    'css',
                    'js']
    ...
    file_to_render = 'index-week-puzzles.html'

    render_template(jsonPuzzlePath,
                    context,
                    "{}/{}".format(templateFolder, file_to_render),
...
def read_input():
    ...
    parser.add_argument("template_folder",
                        help="Path to html template folder.")
...
if __name__ == "__main__":
    args = read_input()
    render_page(args.template_folder,args.json_puzzle_path,args.output_folder,args.cookie_unique_id)
