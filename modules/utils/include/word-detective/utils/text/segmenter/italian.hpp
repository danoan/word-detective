#ifndef WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_ITALIAN_HPP
#define WORD_DETECTIVE_UTILS_TEXT_SEGMENTER_ITALIAN_HPP
...
class ItalianSegmenter : public SegmenterInterface {
 public:
 ...
 public:
  explicit ItalianSegmenter(std::istream* in_stream,
                            FilterFunction filter = always_true_filter)
...
template <>
class SegmenterSelector<Languages::Italian> {
 public:
  using Segmenter = ItalianSegmenter;
};
